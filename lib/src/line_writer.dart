...
class LineWriter
{
    ...
    LineWriter._(this._chunks, this._lineEnding, this.pageWidth, this._blockIndentation,
        this._blockCache, this._formatter);
    ...
    int _completeLine(int start, int end)
    {
        ...
        var splitter = LineSplitter(this, chunks, _blockIndentation, _formatter);
        ...
        for (var i = 0; i < chunks.length; i++)
        {
            ...
            if (splits.shouldSplitAt(i))
            {
                ...
                //! CHANGED(tekert): Use tabs for indents.
                if (_formatter.options.insertSpaces)
