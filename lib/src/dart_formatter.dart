...
import 'package:dart_polisher/src/dart_formatter_options.dart';
...
export 'package:dart_polisher/src/dart_formatter_options.dart';
...
class DartFormatter
{
    ...
    //TODO (tekert): remove these 4 fields and refactor to use [options].
    ...
    //  DartFormatter (FormatterOptions? formatOptions) :
    //options = formatOptions ?? FormatterOptions(),
    ...
    String format(String source, {uri})
    {
        ...
        return formatSource(SourceCode(source, uri: uri, isCompilationUnit: true)).text;
    }
